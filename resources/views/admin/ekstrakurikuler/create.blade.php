        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Isi formulir untuk menambahkan kegiatan ekstrakurikuler baru.
                </p>
            </div>
    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
        <form action="{{ route('admin.ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- 
              ...
              - Mengirim `['ekstrakurikuler' => null]` menandakan ini mode 'create'.
            --}}
            @include('admin.ekstrakurikuler._form', ['ekstrakurikuler' => null])
